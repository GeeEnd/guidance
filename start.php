					...
					<div class="login-right">
						<div class="login-right-wrap">
                            ...
                            <div class="form-group">
								<a class="btn btn-primary btn-block" href="login.php" role="button">Administrator</a></div>
								<div class="form-group">
								<a class="btn btn-primary btn-block" href="login.php" role="button">Counselor</a></div>
                                <div class="form-group">
								<a class="btn btn-primary btn-block" href="index.php" role="button">Student</a></div>
								<div>
						</div>
					</div>
				</div>
